...
#include "csmlio/lio/proto/tsdf_2d.pb.h"
...
class Grid2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Grid2D) */ {
 public:
  ...
  const ::csmlio::mapping::proto::MapLimits& limits() const;
  ::csmlio::mapping::proto::MapLimits* mutable_limits();
  ::csmlio::mapping::proto::MapLimits* release_limits();
  void set_allocated_limits(::csmlio::mapping::proto::MapLimits* limits);
  ...
  const ::csmlio::mapping::proto::Grid2D_CellBox& known_cells_box() const;
  ::csmlio::mapping::proto::Grid2D_CellBox* mutable_known_cells_box();
  ::csmlio::mapping::proto::Grid2D_CellBox* release_known_cells_box();
  void set_allocated_known_cells_box(::csmlio::mapping::proto::Grid2D_CellBox* known_cells_box);
  ...
  const ::csmlio::mapping::proto::ProbabilityGrid& probability_grid_2d() const;
  ::csmlio::mapping::proto::ProbabilityGrid* mutable_probability_grid_2d();
  ::csmlio::mapping::proto::ProbabilityGrid* release_probability_grid_2d();
  void set_allocated_probability_grid_2d(::csmlio::mapping::proto::ProbabilityGrid* probability_grid_2d);

  // .cartographer.mapping.proto.TSDF2D tsdf_2d = 5;
  bool has_tsdf_2d() const;
  void clear_tsdf_2d();
  static const int kTsdf2DFieldNumber = 5;
  const ::csmlio::mapping::proto::TSDF2D& tsdf_2d() const;
  ::csmlio::mapping::proto::TSDF2D* mutable_tsdf_2d();
  ::csmlio::mapping::proto::TSDF2D* release_tsdf_2d();
  void set_allocated_tsdf_2d(::csmlio::mapping::proto::TSDF2D* tsdf_2d);
 ...
 private:
  ...
  ::csmlio::mapping::proto::MapLimits* limits_;
  ::csmlio::mapping::proto::Grid2D_CellBox* known_cells_box_;
  float min_correspondence_cost_;
  float max_correspondence_cost_;
  union GridUnion {
    GridUnion() {}
    ::csmlio::mapping::proto::ProbabilityGrid* probability_grid_2d_;
    ::csmlio::mapping::proto::TSDF2D* tsdf_2d_;
  } grid_;
  mutable int _cached_size_;
...
inline const ::csmlio::mapping::proto::MapLimits& Grid2D::limits() const {
...
inline ::csmlio::mapping::proto::MapLimits* Grid2D::mutable_limits() {
...
inline ::csmlio::mapping::proto::MapLimits* Grid2D::release_limits() {
...
inline void Grid2D::set_allocated_limits(::csmlio::mapping::proto::MapLimits* limits) {
  delete limits_;
  limits_ = limits;
  if (limits) {
...
inline const ::csmlio::mapping::proto::Grid2D_CellBox& Grid2D::known_cells_box() const {
...
inline ::csmlio::mapping::proto::Grid2D_CellBox* Grid2D::mutable_known_cells_box() {
...
inline ::csmlio::mapping::proto::Grid2D_CellBox* Grid2D::release_known_cells_box() {
...
inline void Grid2D::set_allocated_known_cells_box(::csmlio::mapping::proto::Grid2D_CellBox* known_cells_box) {
...
inline  const ::csmlio::mapping::proto::ProbabilityGrid& Grid2D::probability_grid_2d() const {
...
inline ::csmlio::mapping::proto::ProbabilityGrid* Grid2D::mutable_probability_grid_2d() {
  if (!has_probability_grid_2d()) {
    clear_grid();
...
inline ::csmlio::mapping::proto::ProbabilityGrid* Grid2D::release_probability_grid_2d() {
...
inline void Grid2D::set_allocated_probability_grid_2d(::csmlio::mapping::proto::ProbabilityGrid* probability_grid_2d) {
  clear_grid();
...
inline  const ::csmlio::mapping::proto::TSDF2D& Grid2D::tsdf_2d() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.Grid2D.tsdf_2d)
  return has_tsdf_2d()
      ? *grid_.tsdf_2d_
      : ::csmlio::mapping::proto::TSDF2D::default_instance();
}
inline ::csmlio::mapping::proto::TSDF2D* Grid2D::mutable_tsdf_2d() {
  if (!has_tsdf_2d()) {
    clear_grid();
    set_has_tsdf_2d();
...
inline ::csmlio::mapping::proto::TSDF2D* Grid2D::release_tsdf_2d() {
...
inline void Grid2D::set_allocated_tsdf_2d(::csmlio::mapping::proto::TSDF2D* tsdf_2d) {
  clear_grid();
  if (tsdf_2d) {
    set_has_tsdf_2d();

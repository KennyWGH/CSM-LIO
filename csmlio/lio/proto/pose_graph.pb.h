...
class PoseGraph_Constraint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseGraph.Constraint) */ {
 public:
  ...
  ::csmlio::mapping::proto::PoseGraph_Constraint_Tag tag() const;
  void set_tag(::csmlio::mapping::proto::PoseGraph_Constraint_Tag value);
...
class PoseGraph_LandmarkPose : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseGraph.LandmarkPose) */ {
 public:
  ...
  const ::csmlio::transform::proto::Rigid3d& global_pose() const;
  ::csmlio::transform::proto::Rigid3d* mutable_global_pose();
  ::csmlio::transform::proto::Rigid3d* release_global_pose();
  void set_allocated_global_pose(::csmlio::transform::proto::Rigid3d* global_pose);
 ...
 private:
  ...
  ::csmlio::transform::proto::Rigid3d* global_pose_;
  mutable int _cached_size_;
  friend struct protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class PoseGraph : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseGraph) */ {
 public:
  ...
  const ::csmlio::mapping::proto::PoseGraph_Constraint& constraint(int index) const;
  ::csmlio::mapping::proto::PoseGraph_Constraint* mutable_constraint(int index);
  ::csmlio::mapping::proto::PoseGraph_Constraint* add_constraint();
  ...
  const ::csmlio::mapping::proto::Trajectory& trajectory(int index) const;
  ::csmlio::mapping::proto::Trajectory* mutable_trajectory(int index);
  ::csmlio::mapping::proto::Trajectory* add_trajectory();
  ...
  const ::csmlio::mapping::proto::PoseGraph_LandmarkPose& landmark_poses(int index) const;
  ::csmlio::mapping::proto::PoseGraph_LandmarkPose* mutable_landmark_poses(int index);
  ::csmlio::mapping::proto::PoseGraph_LandmarkPose* add_landmark_poses();
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::csmlio::mapping::proto::PoseGraph_Constraint > constraint_;
  ::google::protobuf::RepeatedPtrField< ::csmlio::mapping::proto::Trajectory > trajectory_;
  ::google::protobuf::RepeatedPtrField< ::csmlio::mapping::proto::PoseGraph_LandmarkPose > landmark_poses_;
  mutable int _cached_size_;
  friend struct protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::csmlio::mapping::proto::SubmapId& PoseGraph_Constraint::submap_id() const {
...
inline ::csmlio::mapping::proto::SubmapId* PoseGraph_Constraint::mutable_submap_id() {
...
inline ::csmlio::mapping::proto::SubmapId* PoseGraph_Constraint::release_submap_id() {
...
inline void PoseGraph_Constraint::set_allocated_submap_id(::csmlio::mapping::proto::SubmapId* submap_id) {
  delete submap_id_;
...
inline const ::csmlio::mapping::proto::NodeId& PoseGraph_Constraint::node_id() const {
...
inline ::csmlio::mapping::proto::NodeId* PoseGraph_Constraint::mutable_node_id() {
...
inline ::csmlio::mapping::proto::NodeId* PoseGraph_Constraint::release_node_id() {
...
inline void PoseGraph_Constraint::set_allocated_node_id(::csmlio::mapping::proto::NodeId* node_id) {
  delete node_id_;
  node_id_ = node_id;
  if (node_id) {
...
inline const ::csmlio::transform::proto::Rigid3d& PoseGraph_Constraint::relative_pose() const {
...
inline ::csmlio::transform::proto::Rigid3d* PoseGraph_Constraint::mutable_relative_pose() {
...
inline ::csmlio::transform::proto::Rigid3d* PoseGraph_Constraint::release_relative_pose() {
...
inline void PoseGraph_Constraint::set_allocated_relative_pose(::csmlio::transform::proto::Rigid3d* relative_pose) {
...
inline ::csmlio::mapping::proto::PoseGraph_Constraint_Tag PoseGraph_Constraint::tag() const {
...
inline void PoseGraph_Constraint::set_tag(::csmlio::mapping::proto::PoseGraph_Constraint_Tag value) {
...
inline const ::csmlio::transform::proto::Rigid3d& PoseGraph_LandmarkPose::global_pose() const {
...
inline ::csmlio::transform::proto::Rigid3d* PoseGraph_LandmarkPose::mutable_global_pose() {
...
inline ::csmlio::transform::proto::Rigid3d* PoseGraph_LandmarkPose::release_global_pose() {
...
inline void PoseGraph_LandmarkPose::set_allocated_global_pose(::csmlio::transform::proto::Rigid3d* global_pose) {
  delete global_pose_;
...
inline const ::csmlio::mapping::proto::PoseGraph_LandmarkPose& PoseGraph::landmark_poses(int index) const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.PoseGraph.landmark_poses)
  return landmark_poses_.Get(index);
}
inline ::csmlio::mapping::proto::PoseGraph_LandmarkPose* PoseGraph::mutable_landmark_poses(int index) {
...
inline ::csmlio::mapping::proto::PoseGraph_LandmarkPose* PoseGraph::add_landmark_poses() {
  // @@protoc_insertion_point(field_add:cartographer.mapping.proto.PoseGraph.landmark_poses)
  return landmark_poses_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::csmlio::mapping::proto::PoseGraph_LandmarkPose >*
...
inline const ::google::protobuf::RepeatedPtrField< ::csmlio::mapping::proto::PoseGraph_LandmarkPose >&
...
template <> struct is_proto_enum< ::csmlio::mapping::proto::PoseGraph_Constraint_Tag> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::csmlio::mapping::proto::PoseGraph_Constraint_Tag>() {
  return ::csmlio::mapping::proto::PoseGraph_Constraint_Tag_descriptor();
}

...
#ifndef INFINITYSLAM_CSMLIO_INTERNAL_OPTIMIZATION_CERES_POSE_H_
#define INFINITYSLAM_CSMLIO_INTERNAL_OPTIMIZATION_CERES_POSE_H_
...
#endif  // INFINITYSLAM_CSMLIO_INTERNAL_OPTIMIZATION_CERES_POSE_H_

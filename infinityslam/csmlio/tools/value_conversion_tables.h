...
#ifndef INFINITYSLAM_CSMLIO_VALUE_CONVERSION_TABLES_H_
#define INFINITYSLAM_CSMLIO_VALUE_CONVERSION_TABLES_H_
...
#endif  // INFINITYSLAM_CSMLIO_VALUE_CONVERSION_TABLES_H_

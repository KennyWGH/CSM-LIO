...
#ifndef CSMLIO_IO_INTERNAL_IN_MEMORY_PROTO_STREAM_H_
#define CSMLIO_IO_INTERNAL_IN_MEMORY_PROTO_STREAM_H_
...
class ForwardingProtoStreamWriter
    : public csmlio::io::ProtoStreamWriterInterface {
 public:
...
class InMemoryProtoStreamReader
    : public csmlio::io::ProtoStreamReaderInterface {
 public:
...
#endif  // CSMLIO_IO_INTERNAL_IN_MEMORY_PROTO_STREAM_H_

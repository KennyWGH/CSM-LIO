...
#ifndef CSMLIO_MAPPING_POSE_EXTRAPOLATOR_INTERFACE_H_
#define CSMLIO_MAPPING_POSE_EXTRAPOLATOR_INTERFACE_H_
...
#endif  // CSMLIO_MAPPING_POSE_EXTRAPOLATOR_INTERFACE_H_

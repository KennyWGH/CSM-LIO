...
// #include "csmlio/io/proto_stream.h"
// #include "csmlio/io/serialization_format_migration.h"
...
//     return EXIT_FAILURE;
//   }
//   csmlio::io::ProtoStreamReader input(argv[2]);
//   csmlio::io::ProtoStreamWriter output(argv[3]);
//   LOG(INFO) << "Migrating serialization format 1 in \"" << argv[2]
//             << "\" to serialization format 2 in \"" << argv[3] << "\"";
//   csmlio::io::MigrateStreamVersion1ToVersion2(

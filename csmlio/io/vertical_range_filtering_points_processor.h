...
#ifndef CSMLIO_IO_VERTICAL_RANGE_FILTERING_POINTS_PROCESSOR_H_
#define CSMLIO_IO_VERTICAL_RANGE_FILTERING_POINTS_PROCESSOR_H_
...
#endif  // CSMLIO_IO_VERTICAL_RANGE_FILTERING_POINTS_PROCESSOR_H_

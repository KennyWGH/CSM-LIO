...
#ifndef INFINITYSLAM_CSMLIO_EIGEN_QUATERNIOND_FROM_TWO_VECTORS_H_
#define INFINITYSLAM_CSMLIO_EIGEN_QUATERNIOND_FROM_TWO_VECTORS_H_
...
#endif  // INFINITYSLAM_CSMLIO_EIGEN_QUATERNIOND_FROM_TWO_VECTORS_H_

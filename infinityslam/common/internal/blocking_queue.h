...
#ifndef CSMLIO_COMMON_BLOCKING_QUEUE_H_
#define CSMLIO_COMMON_BLOCKING_QUEUE_H_
...
/// 王冠华：Cartographer实现了一个“阻塞队列”，尽管现在还不知道用处在哪里。
/// 所谓阻塞队列：队列为空时，从队列读取元素的线程将被刮起（阻塞）；
/// 当队列满时，向队列添加元素的线程将被挂起。
...
#endif  // CSMLIO_COMMON_BLOCKING_QUEUE_H_

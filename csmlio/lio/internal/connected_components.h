...
#ifndef CSMLIO_MAPPING_INTERNAL_CONNECTED_COMPONENTS_H_
#define CSMLIO_MAPPING_INTERNAL_CONNECTED_COMPONENTS_H_
...
#endif  // CSMLIO_MAPPING_INTERNAL_CONNECTED_COMPONENTS_H_

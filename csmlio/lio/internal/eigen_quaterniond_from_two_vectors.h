...
#ifndef CSMLIO_MAPPING_EIGEN_QUATERNIOND_FROM_TWO_VECTORS_H_
#define CSMLIO_MAPPING_EIGEN_QUATERNIOND_FROM_TWO_VECTORS_H_
...
#endif  // CSMLIO_MAPPING_EIGEN_QUATERNIOND_FROM_TWO_VECTORS_H_

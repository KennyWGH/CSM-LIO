...
class Submap2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Submap2D) */ {
 public:
  ...
  const ::csmlio::mapping::proto::Grid2D& grid() const;
  ::csmlio::mapping::proto::Grid2D* mutable_grid();
  ::csmlio::mapping::proto::Grid2D* release_grid();
  void set_allocated_grid(::csmlio::mapping::proto::Grid2D* grid);
 ...
 private:
  ...
  ::csmlio::mapping::proto::Grid2D* grid_;
...
class Submap3D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Submap3D) */ {
 public:
  ...
  const ::csmlio::mapping::proto::HybridGrid& high_resolution_hybrid_grid() const;
  ::csmlio::mapping::proto::HybridGrid* mutable_high_resolution_hybrid_grid();
  ::csmlio::mapping::proto::HybridGrid* release_high_resolution_hybrid_grid();
  void set_allocated_high_resolution_hybrid_grid(::csmlio::mapping::proto::HybridGrid* high_resolution_hybrid_grid);
  ...
  const ::csmlio::mapping::proto::HybridGrid& low_resolution_hybrid_grid() const;
  ::csmlio::mapping::proto::HybridGrid* mutable_low_resolution_hybrid_grid();
  ::csmlio::mapping::proto::HybridGrid* release_low_resolution_hybrid_grid();
  void set_allocated_low_resolution_hybrid_grid(::csmlio::mapping::proto::HybridGrid* low_resolution_hybrid_grid);
 ...
 private:
  ...
  ::csmlio::transform::proto::Rigid3d* local_pose_;
  ::csmlio::mapping::proto::HybridGrid* high_resolution_hybrid_grid_;
  ::csmlio::mapping::proto::HybridGrid* low_resolution_hybrid_grid_;
  ::google::protobuf::int32 num_range_data_;
  bool finished_;
  mutable int _cached_size_;
  friend struct protobuf_cartographer_2fmapping_2fproto_2fsubmap_2eproto::TableStruct;
...
inline const ::csmlio::transform::proto::Rigid3d& Submap2D::local_pose() const {
...
inline ::csmlio::transform::proto::Rigid3d* Submap2D::mutable_local_pose() {
...
inline ::csmlio::transform::proto::Rigid3d* Submap2D::release_local_pose() {
...
inline void Submap2D::set_allocated_local_pose(::csmlio::transform::proto::Rigid3d* local_pose) {
  delete local_pose_;
...
inline const ::csmlio::mapping::proto::Grid2D& Submap2D::grid() const {
...
inline ::csmlio::mapping::proto::Grid2D* Submap2D::mutable_grid() {
...
inline ::csmlio::mapping::proto::Grid2D* Submap2D::release_grid() {
...
inline void Submap2D::set_allocated_grid(::csmlio::mapping::proto::Grid2D* grid) {
  delete grid_;
  grid_ = grid;
  if (grid) {
...
inline const ::csmlio::transform::proto::Rigid3d& Submap3D::local_pose() const {
  const ::csmlio::transform::proto::Rigid3d* p = local_pose_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.Submap3D.local_pose)
  return p != NULL ? *p : *reinterpret_cast<const ::csmlio::transform::proto::Rigid3d*>(
      &::csmlio::transform::proto::_Rigid3d_default_instance_);
}
inline ::csmlio::transform::proto::Rigid3d* Submap3D::mutable_local_pose() {
...
inline ::csmlio::transform::proto::Rigid3d* Submap3D::release_local_pose() {
...
inline void Submap3D::set_allocated_local_pose(::csmlio::transform::proto::Rigid3d* local_pose) {
  delete local_pose_;
  local_pose_ = local_pose;
  if (local_pose) {
...
inline const ::csmlio::mapping::proto::HybridGrid& Submap3D::high_resolution_hybrid_grid() const {
...
inline ::csmlio::mapping::proto::HybridGrid* Submap3D::mutable_high_resolution_hybrid_grid() {
...
inline ::csmlio::mapping::proto::HybridGrid* Submap3D::release_high_resolution_hybrid_grid() {
...
inline void Submap3D::set_allocated_high_resolution_hybrid_grid(::csmlio::mapping::proto::HybridGrid* high_resolution_hybrid_grid) {
...
inline const ::csmlio::mapping::proto::HybridGrid& Submap3D::low_resolution_hybrid_grid() const {
...
inline ::csmlio::mapping::proto::HybridGrid* Submap3D::mutable_low_resolution_hybrid_grid() {
...
inline ::csmlio::mapping::proto::HybridGrid* Submap3D::release_low_resolution_hybrid_grid() {
...
inline void Submap3D::set_allocated_low_resolution_hybrid_grid(::csmlio::mapping::proto::HybridGrid* low_resolution_hybrid_grid) {

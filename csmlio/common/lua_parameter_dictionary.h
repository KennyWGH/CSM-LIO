...
#ifndef CSMLIO_COMMON_LUA_PARAMETER_DICTIONARY_H_
#define CSMLIO_COMMON_LUA_PARAMETER_DICTIONARY_H_
...
#endif  // CSMLIO_COMMON_LUA_PARAMETER_DICTIONARY_H_

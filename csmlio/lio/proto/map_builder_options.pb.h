...
class MapBuilderOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.MapBuilderOptions) */ {
 public:
  ...
  const ::csmlio::mapping::proto::PoseGraphOptions& pose_graph_options() const;
  ::csmlio::mapping::proto::PoseGraphOptions* mutable_pose_graph_options();
  ::csmlio::mapping::proto::PoseGraphOptions* release_pose_graph_options();
  void set_allocated_pose_graph_options(::csmlio::mapping::proto::PoseGraphOptions* pose_graph_options);
 ...
 private:
  ...
  ::csmlio::mapping::proto::PoseGraphOptions* pose_graph_options_;
...
inline const ::csmlio::mapping::proto::PoseGraphOptions& MapBuilderOptions::pose_graph_options() const {
...
inline ::csmlio::mapping::proto::PoseGraphOptions* MapBuilderOptions::mutable_pose_graph_options() {
...
inline ::csmlio::mapping::proto::PoseGraphOptions* MapBuilderOptions::release_pose_graph_options() {
...
inline void MapBuilderOptions::set_allocated_pose_graph_options(::csmlio::mapping::proto::PoseGraphOptions* pose_graph_options) {

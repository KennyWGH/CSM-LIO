...
#ifndef CSMLIO_MAPPING_INTERNAL_OPTIMIZATION_CERES_POSE_H_
#define CSMLIO_MAPPING_INTERNAL_OPTIMIZATION_CERES_POSE_H_
...
#endif  // CSMLIO_MAPPING_INTERNAL_OPTIMIZATION_CERES_POSE_H_

...
#include "infinityslam/csmlio/internal/optimization/cost_functions/spa_cost_function_2d.h"
...
class SpaCostFunction2D {
 public:
  explicit SpaCostFunction2D(
      const optimization::Constraint::Pose& observed_relative_pose)
 ...
 private:
  const optimization::Constraint::Pose observed_relative_pose_;
};
...
class AnalyticalSpaCostFunction2D
 ...
 public:
  explicit AnalyticalSpaCostFunction2D(
      const optimization::Constraint::Pose& constraint_pose)

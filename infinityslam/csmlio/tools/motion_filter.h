...
#ifndef INFINITYSLAM_CSMLIO_INTERNAL_MOTION_FILTER_H_
#define INFINITYSLAM_CSMLIO_INTERNAL_MOTION_FILTER_H_
...
#endif  // INFINITYSLAM_CSMLIO_INTERNAL_MOTION_FILTER_H_

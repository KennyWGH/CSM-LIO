...
class CeresScanMatcherOptions3D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.scan_matching.proto.CeresScanMatcherOptions3D) */ {
 public:
  ...
  const ::csmlio::mapping::scan_matching::proto::IntensityCostFunctionOptions& intensity_cost_function_options(int index) const;
  ::csmlio::mapping::scan_matching::proto::IntensityCostFunctionOptions* mutable_intensity_cost_function_options(int index);
  ::csmlio::mapping::scan_matching::proto::IntensityCostFunctionOptions* add_intensity_cost_function_options();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::csmlio::mapping::scan_matching::proto::IntensityCostFunctionOptions > intensity_cost_function_options_;
...
inline const ::csmlio::common::proto::CeresSolverOptions& CeresScanMatcherOptions3D::ceres_solver_options() const {
...
inline ::csmlio::common::proto::CeresSolverOptions* CeresScanMatcherOptions3D::mutable_ceres_solver_options() {
...
inline ::csmlio::common::proto::CeresSolverOptions* CeresScanMatcherOptions3D::release_ceres_solver_options() {
...
inline void CeresScanMatcherOptions3D::set_allocated_ceres_solver_options(::csmlio::common::proto::CeresSolverOptions* ceres_solver_options) {
...
inline const ::csmlio::mapping::scan_matching::proto::IntensityCostFunctionOptions& CeresScanMatcherOptions3D::intensity_cost_function_options(int index) const {
...
inline ::csmlio::mapping::scan_matching::proto::IntensityCostFunctionOptions* CeresScanMatcherOptions3D::mutable_intensity_cost_function_options(int index) {
...
inline ::csmlio::mapping::scan_matching::proto::IntensityCostFunctionOptions* CeresScanMatcherOptions3D::add_intensity_cost_function_options() {
...
inline ::google::protobuf::RepeatedPtrField< ::csmlio::mapping::scan_matching::proto::IntensityCostFunctionOptions >*
...
inline const ::google::protobuf::RepeatedPtrField< ::csmlio::mapping::scan_matching::proto::IntensityCostFunctionOptions >&

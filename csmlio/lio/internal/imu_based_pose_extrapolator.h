...
#ifndef CSMLIO_MAPPING_IMU_BASED_POSE_EXTRAPOLATOR_H_
#define CSMLIO_MAPPING_IMU_BASED_POSE_EXTRAPOLATOR_H_
...
#include "csmlio/common/histogram.h"
...
class ImuBasedPoseExtrapolator : public PoseExtrapolatorInterface {
  ...
  private:
    ...
    std::vector<transform::Rigid3f> InterpolatePoses(
        const ::csmlio::transform::TimestampedTransform& start,
        const ::csmlio::transform::TimestampedTransform& end,
        const std::vector<common::Time>::const_iterator times_begin,
        const std::vector<common::Time>::const_iterator times_end);

    std::deque<::csmlio::transform::TimestampedTransform> timed_pose_queue_;
    std::deque<::csmlio::transform::TimestampedTransform>
        previous_solution_;
...
#endif  // CSMLIO_MAPPING_IMU_BASED_POSE_EXTRAPOLATOR_H_

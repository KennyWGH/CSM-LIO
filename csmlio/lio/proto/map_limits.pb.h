...
class MapLimits : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.MapLimits) */ {
 public:
  ...
  const ::csmlio::transform::proto::Vector2d& max() const;
  ::csmlio::transform::proto::Vector2d* mutable_max();
  ::csmlio::transform::proto::Vector2d* release_max();
  void set_allocated_max(::csmlio::transform::proto::Vector2d* max);
  ...
  const ::csmlio::mapping::proto::CellLimits& cell_limits() const;
  ::csmlio::mapping::proto::CellLimits* mutable_cell_limits();
  ::csmlio::mapping::proto::CellLimits* release_cell_limits();
  void set_allocated_cell_limits(::csmlio::mapping::proto::CellLimits* cell_limits);
 ...
 private:
  ...
  ::csmlio::transform::proto::Vector2d* max_;
  ::csmlio::mapping::proto::CellLimits* cell_limits_;
  double resolution_;
...
inline const ::csmlio::transform::proto::Vector2d& MapLimits::max() const {
...
inline ::csmlio::transform::proto::Vector2d* MapLimits::mutable_max() {
...
inline ::csmlio::transform::proto::Vector2d* MapLimits::release_max() {
...
inline void MapLimits::set_allocated_max(::csmlio::transform::proto::Vector2d* max) {
  delete max_;
  max_ = max;
  if (max) {
...
inline const ::csmlio::mapping::proto::CellLimits& MapLimits::cell_limits() const {
...
inline ::csmlio::mapping::proto::CellLimits* MapLimits::mutable_cell_limits() {
...
inline ::csmlio::mapping::proto::CellLimits* MapLimits::release_cell_limits() {
...
inline void MapLimits::set_allocated_cell_limits(::csmlio::mapping::proto::CellLimits* cell_limits) {
  delete cell_limits_;

...
#include "csmlio/lio/map_builder_interface.h"
#include "glog/logging.h"

namespace ros_app {

NodeOptions CreateNodeOptions(
    ::csmlio::common::LuaParameterDictionary* const
        lua_parameter_dictionary) {
  NodeOptions options;
  options.map_builder_options =
      ::csmlio::mapping::CreateMapBuilderOptions(
...
std::tuple<NodeOptions, TrajectoryOptions> LoadOptions(
  ...
  auto file_resolver =
      absl::make_unique<csmlio::common::ConfigurationFileResolver>(

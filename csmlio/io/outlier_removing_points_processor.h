...
#ifndef CSMLIO_IO_OUTLIER_REMOVING_POINTS_PROCESSOR_H_
#define CSMLIO_IO_OUTLIER_REMOVING_POINTS_PROCESSOR_H_
...
#endif  // CSMLIO_IO_OUTLIER_REMOVING_POINTS_PROCESSOR_H_

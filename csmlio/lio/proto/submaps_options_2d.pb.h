...
class SubmapsOptions2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.SubmapsOptions2D) */ {
 public:
  ...
  const ::csmlio::mapping::proto::GridOptions2D& grid_options_2d() const;
  ::csmlio::mapping::proto::GridOptions2D* mutable_grid_options_2d();
  ::csmlio::mapping::proto::GridOptions2D* release_grid_options_2d();
  void set_allocated_grid_options_2d(::csmlio::mapping::proto::GridOptions2D* grid_options_2d);
  ...
  const ::csmlio::mapping::proto::RangeDataInserterOptions& range_data_inserter_options() const;
  ::csmlio::mapping::proto::RangeDataInserterOptions* mutable_range_data_inserter_options();
  ::csmlio::mapping::proto::RangeDataInserterOptions* release_range_data_inserter_options();
  void set_allocated_range_data_inserter_options(::csmlio::mapping::proto::RangeDataInserterOptions* range_data_inserter_options);
 ...
 private:
  ...
  ::csmlio::mapping::proto::GridOptions2D* grid_options_2d_;
  ::csmlio::mapping::proto::RangeDataInserterOptions* range_data_inserter_options_;
...
inline const ::csmlio::mapping::proto::GridOptions2D& SubmapsOptions2D::grid_options_2d() const {
...
inline ::csmlio::mapping::proto::GridOptions2D* SubmapsOptions2D::mutable_grid_options_2d() {
...
inline ::csmlio::mapping::proto::GridOptions2D* SubmapsOptions2D::release_grid_options_2d() {
...
inline void SubmapsOptions2D::set_allocated_grid_options_2d(::csmlio::mapping::proto::GridOptions2D* grid_options_2d) {
...
inline const ::csmlio::mapping::proto::RangeDataInserterOptions& SubmapsOptions2D::range_data_inserter_options() const {
...
inline ::csmlio::mapping::proto::RangeDataInserterOptions* SubmapsOptions2D::mutable_range_data_inserter_options() {
...
inline ::csmlio::mapping::proto::RangeDataInserterOptions* SubmapsOptions2D::release_range_data_inserter_options() {
...
inline void SubmapsOptions2D::set_allocated_range_data_inserter_options(::csmlio::mapping::proto::RangeDataInserterOptions* range_data_inserter_options) {
